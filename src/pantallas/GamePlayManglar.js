...
var nivel2= {
    ...
    create: function(){
        ...
        platLimpio2.height = (window.innerHeight*3)/100;
        platLimpio2.x=(window.innerWidth)-(platLimpio2.width/3.5);
        ...
        var platLimpio5 = game.add.sprite((window.innerWidth*0)/100,(window.innerHeight*60)/100,'platLimpio5');
        platLimpio5.width = (window.innerWidth*28)/100;
        platLimpio5.height = (window.innerHeight*3)/100;

        var platLimpio6 = game.add.sprite((window.innerWidth*86)/100,(window.innerHeight*65)/100,'platLimpio1');
        ...
        for(var i=1; i<=cant_plat_1_nivel2; i++){
            ...
            switch(i){
                ...
                break;
                case 2:
                        this.plataformas[i].body.angle=-45;
                break;
                case 3:
                        if(!this.isIpad&&!this.isPixel2XL){
        ...
        /****BASUREROS****************************************************************************************************/
         ...
         var basurero_0 = game.add.sprite((window.innerWidth*74)/100,(window.innerHeight*50)/100,'basureros');
            ...
            basurero_1.frame = 1;
            var basurero_2 = game.add.sprite((window.innerWidth*9)/100,(window.innerHeight*78)/100,'basureros');
            basurero_2.frame = 2;
            var basurero_3 = game.add.sprite((window.innerWidth*8)/100,(window.innerHeight*56)/100,'basureros');
        ...
        for (var i = 0; i < cant_tron_1; i++) {
            switch(i){
                case 0:
                    this.troncos[i]=game.add.sprite((window.innerWidth*46)/100,(window.innerHeight*24)/100,"tronco")
                ...
                break;
                case 1:
                    this.troncos[i]=game.add.sprite((window.innerWidth*54)/100,(window.innerHeight*24)/100,"tronco2")
                    this.troncos[i].width = (window.innerWidth*28)/100;
                    this.troncos[i].height = (window.innerHeight*3.5)/100;
                    game.physics.p2.enable(this.troncos[i]);
                    this.troncos[i].body.angle=90;
                break;
                case 2:
                    this.troncos[i]=game.add.sprite((window.innerWidth*52)/100,(window.innerHeight*69)/100,"tronco")
                    this.troncos[i].width = (window.innerWidth*35)/100;
                ...
                break;
                case 3:
                    this.troncos[i]=game.add.sprite((window.innerWidth*83)/100,(window.innerHeight*200)/100,"tronco") 
                    this.troncos[i].width = (window.innerWidth*30)/100;
                    this.troncos[i].height = (window.innerHeight*3)/100;
                    game.physics.p2.enable(this.troncos[i]);
                    if(this.isPixel2XL){
    ...
    tocandoTronco: function(tronco){
        ...
        if(tronco.name==1){
            ...
            switch(estado){
                                        ...
                                        this.troncos[tronco.name].body.y=(window.innerHeight*24)/100;
                                        break;
                                        case 2:
                    ...
                    if(!tronco.activado){
                        ...
                        switch(tronco.name){
                            ...
                            case 2: 
                                    ...
                                    this.troncos[tronco.name].body.y=(window.innerHeight*60)/100;
                                    this.troncos[tronco.name].body.clearShapes();
                                    this.troncos[tronco.name].body.addRectangle((this.troncos[tronco.name].width*96)/100,(this.troncos[tronco.name].height*75)/100);
                                    if (this.isPixel2XL) {
                                        this.troncos[tronco.name].body.y=(window.innerHeight*66)/100;
                        ...
                        switch(tronco.name){
                            case 0: 
                                    this.troncos[tronco.name].body.angle=90;
                                    this.troncos[tronco.name].body.x=(window.innerWidth*44.5)/100;
                                    this.troncos[tronco.name].body.y=(window.innerHeight*24)/100;
                            break;
                            case 1: 
                                   /* this.troncos[tronco.name].body.angle=90;
                            ...
                            break;
                            case 2:
                                    this.troncos[tronco.name].body.angle=-3;
                                    this.troncos[tronco.name].body.x=(window.innerWidth*52)/100;
                                    this.troncos[tronco.name].body.y=(window.innerHeight*67)/100
                                    this.troncos[tronco.name].body.clearShapes();
                                    this.troncos[tronco.name].body.addRectangle((this.troncos[tronco.name].width*96)/100,(this.troncos[tronco.name].height*75)/100);
...
var estadoFinal = {
    ...
    create: function() {
        ...
        var botonNextLevel = this.add.button(window.innerWidth / 2, (window.innerHeight * 50)/100, 'boton_sig', this.siguienteNivel, this);
        var botonReiniciar = this.add.button(window.innerWidth / 2, (window.innerHeight*70)/100, 'boton_reinicar', this.iniciarJuego, this);
        botonReiniciar.width=window.innerWidth*(50/100);
        botonReiniciar.height=window.innerWidth*(15/100);
        botonNextLevel.width=window.innerWidth*(50/100);
        botonNextLevel.height=window.innerWidth*(15/100);
        botonReiniciar.anchor.setTo(0.5);
        botonNextLevel.anchor.setTo(0.5);
    },
    iniciarJuego: function() {
        this.state.start('GamePlayManglar');
    },
